...
local res1 = request({Url = "https://github.com/paravid/RBMX-SCRIPTS/raw/refs/heads/main/AnimationsNSFWUPDATE.rbxm", Method = "GET"})
assert(res1 and res1.Body)
writefile("AnimationsNSFWUPDATE.rbxm", res1.Body)

local AnimPack = game:GetObjects(getcustomasset("AnimationsNSFWUPDATE.rbxm"))[1]
