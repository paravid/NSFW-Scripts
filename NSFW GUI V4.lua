...
local res1 = request({Url = "https://github.com/paravid/RBMX-SCRIPTS/raw/refs/heads/main/NSFWUPDATEANIMS.rbxm", Method = "GET"})
assert(res1 and res1.Body)
writefile("NSFWUPDATEANIMS.rbxm", res1.Body)

local AnimPack = game:GetObjects(getcustomasset("NSFWUPDATEANIMS.rbxm"))[1]
local AnimSaves = AnimPack:WaitForChild("AnimSaves")

local dances = {
	{Name = "Masturbate", Anim = AnimSaves:WaitForChild("Masturbate"), Speed = 0},
	...
	{Name = "Bored sit2", Anim = AnimSaves:WaitForChild("Bored sit2 "), Speed = 0},
	{Name = "COUCH Kiss", Anim = AnimSaves:WaitForChild("COUCH Kiss "), Speed = 0},
	...
	{Name = "Slurp & jerk", Anim = AnimSaves:WaitForChild("Slurp & jerk "), Speed = 0},
	{Name = "MomsLap", Anim = AnimSaves:WaitForChild("MomsLap "), Speed = 0},
	{Name = "Master", Anim = AnimSaves:WaitForChild("Master "), Speed = 0},
}
